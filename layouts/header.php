...
<head>
    ...
    <link rel='stylesheet' href='https://cdn-uicons.flaticon.com/2.6.0/uicons-solid-rounded/css/uicons-solid-rounded.css'>
    <link rel="shortcut icon" href="assets/img/icon_white.png" type="image/png">
    <title>Intranet Smart</title>
</head>
<body>
<nav class="navbar navbar-expand-lg bg-transparent">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="assets/img/logoWhite.png" alt=""></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php?seccion=soporte">Solicitar soporte tecnico</a></li>
            <li><a class="dropdown-item" href="index.php?seccion=sugerencias">Sugerencias y comentarios</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="index.php?seccion=novedades">Novedades Videss Smart</a></li>
          </ul>
        </li>
      </ul>
    </div>
